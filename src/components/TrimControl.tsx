...
export default function TrimControl({ recipe, onChange, duration }: Props) {
  ...
  const inputClass =
    "w-full text-sm px-3 py-2 border border-[var(--border)] rounded-md bg-[var(--bg)] font-heading focus:outline-none focus:ring-2 focus:ring-accent/40 text-[var(--text)] transition-shadow";
